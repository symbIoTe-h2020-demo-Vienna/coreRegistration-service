...
public class SearchEngine {
    ...
    public ResultSet search(int modelId, String query) {
        ...
        ResultSet mappedModels = tripleStore.executeQueryOnGraph(generateFindMappingsQuery(modelId), Ontology.MAPPING_GRAPH);
    ...
    private String generateFindMappingsQuery(int modelId) {
        ...
        query.setIri("modelGraphURI", Ontology.getModelGraphURI(modelId));
